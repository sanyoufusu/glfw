...
around the world, whether by bug reporting, community support, new features,
testing, proofreading, bug fixes, feature suggestions or debugging.
...
## Changelog
 ...
 - Added `GLFW_POSITION_X` and `GLFW_POSITION_Y` window hints for initial position (#1603)
 - Added `GLFW_ANY_POSITION` hint value for letting the window manager choose (#1603)
